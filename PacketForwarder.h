...
class PacketForwarder : public cSimpleModule, public cListener
{
  protected:
    ...
    std::queue<Packet*> pendingLoRaPackets;  // Queue for incoming messages
    bool waitingForServerResponse = false;   // Flag to track server responses
